...
Σκεπτόμενοι τα αντιστρέψιμα στοιχεία ως εκείνα τα στοιχεία που \textquote{συμπεριφέρονται} ως μονάδες με την έννοια της παρατήρησης, τότε τα ανάγωγα στοιχεία ενός δακτύλιου μπο\-ρούμε να τα φανταστούμε ως \emph{δομικά συστατικά} ενός αυθαίρετου στοιχείου ως προς τον πολλαπλασιασμό. Στην περίπτωση όπου $R = \ZZ$ οι έννοιες ανάγωγο και πρώτο στοιχείο ταυτίζονται (γιατί;). Παρακάτω θα δούμε ότι το ίδιο ισχύει σε κάθε περιοχή κύριων ιδεωδών. Συνεπώς, τα δομικά συστατικά σε μια περιοχή κύριων ιδεωδών συμπεριφέρονται ακριβώς όπως και οι πρώτοι αριθμοί στο $\ZZ$. Γενικότερα, ισχύει το εξής.
\begin{proposition}

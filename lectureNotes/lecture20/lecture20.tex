...
\begin{proof}[Απόδειξη του Θεωρήματος \ref{thm:hilbert_basis}]
    ...
    \]
    Θα το κάνουμε με επαγωγή ως προς τον βαθμό του $h$. Αν το $\deg(h) = 0$, τότε $h = 0$ και το ζητούμενο έπεται τετριμμένα. Αυτή είναι η βάση της επαγωγής. Υποθέτουμε ότι $\deg(h) > 0$ και ότι κάθε πολυώνυμο βαθμού μικρότερου από $\deg(h)$ μπορεί να γραφεί ως $R[x]$-γραμμικός συνδυασμός των $f_i$ και $g_j$, για κάθε $1 \le i \le k$ και $1 \le j \le \ell$. Αν $\deg(h) \le d$, τότε $h \in I^{\le d} \subseteq I$ και το ζητούμενο έπεται.
